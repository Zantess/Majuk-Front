...
const borderImg = '../images/cartes/Carte_Modele_Degats_ss_icones.png'


const Card = ({name,type,image,mana,attack,HP,desc,effect, addToDeck}) => {

    return (
        <div className="carte"  onClick={() => addToDeck(name)} style={{backgroundImage :`url(${borderImg})`}}>
            <img className="carteBord" src={image} alt="Bord de carte"/>
